      ...
      <ul class="navbar-nav ml-auto">
       <li class="nav-item active">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link" href="alloffer.php">All Offers</a>
        </li>
...
<div class="container">
  <div class="row">
    ...
    <?php
   $r= mysqli_query($con,"select* from tblvendor");
...
<h1 class="text-center">'.$row['fld_name'].'</h1>
<img src="img/'.$row['fld_logo'].'" style="width:100%; height:150px">
<h6>Location: '.$row['fld_address'].'</h6>
<h5 style="color:red">Mobile: '.$row['fld_mob'].'</h5>
<h5 style="color:red">Phone: '.$row['fld_phone'].'</h5>

<a href="info.php?id='.$row['fldvendor_id'].'" class="btn btn-danger">See Food</a>
<a href="reserve.php?id='.$row['fld_email'].'" class="btn btn-danger">Reserve Date</a>
</div>
