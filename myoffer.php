...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
			<h1 class="text-danger">All My Offers</h1>
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<?php
						...
						$r=mysqli_query($con,"select * from offers where fldvendor_id='".$_SESSION['id']."'");
						...
						while($row=mysqli_fetch_array($r))
						{
							...
							<tr>
							<td>'.$row['food_id'].'</td>
							<td>'.$row['fldvendor_id'].'</td>
							<td>'.$row['foodname'].'</td>
							<td>'.$row['cost'].'</td>
							<td>'.$row['newcost'].'</td>
							<td>'.$row['cuisines'].'</td>
							<td><img style="width:100px;height:100px;" src="img/'.$row['fldimage'].'"></td>
							<td><a href="myoffer.php?id='.$row['food_id'].'" class="btn btn-danger btn-sm">delete</a></td>
							</tr>
						...
						if(isset($_GET['id']))
						{
							$r1=mysqli_query($con,"delete from offers where food_id='".$_GET['id']."'");

							echo'<meta http-equiv="refresh" content="0;url=myoffer.php">';
						}
