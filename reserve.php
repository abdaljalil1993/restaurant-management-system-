...
<div class="container">
  <div class="row">
   ...
   $r= mysqli_query($con,"select* from restdate where rest_name='$x' and state=0");
...
<div class="col-md-4 mr-2" style="background-color:#fff;padding:30px;border-radius:14px;box-shadow:0px 0px 1px 1px #cfcfcf;">


<h3>Day : '.$row['day'].'</h3>
<h5 style="color:red">Time : '.$row['time'].'</h5>
...
<a href="reserve.php?dateid='.$row['id'].'" class="btn btn-danger">Do reservation</a>


<a href="park.php?id='.$x.'" class="btn btn-warning"> Reserve Park</a>
...
if(isset($_GET['dateid']))
     {
       $dateid=$_GET['dateid'];
        $r1= mysqli_query($con,"insert into reserve(dateid,cust_id)
...
$r1= mysqli_query($con,"update restdate set state=1 where id='$dateid'");
