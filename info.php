...
header( "refresh:1;url=form/cart.php" );
   ...
   $r= mysqli_query($con,"select* from tbfood where fldvendor_id='$x'");
...
<h6>cuisines: '.$row['cuisines'].'</h6>
<h5 style="color:red">cost: '.$row['cost'].'</h5>
<h5 style="color:red">paymentmode: '.$row['paymentmode'].'</h5>
