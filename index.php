    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item"><!--hotel search-->
		     <a href="#" class="nav-link"><form method="post"><input type="text" name="search_hotel" id="search_hotel" placeholder="Search For Restaurant " class="form-control " /></form></a>
		  </li>
          <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link" href="allrest.php"> Restaurant</a>
        </li>
          <li class="nav-item">
...
<div class="container-fluid">
  <div class="row">
	...
	<?php
	  ...
	  {
		   $hotel_logo= "img"."/".$res['fld_logo'];
		   $food_pic= "img/".$res['fldimage'];
	  ?>
	  <div class="container-fluid">
	  <div class="container-fluid">
