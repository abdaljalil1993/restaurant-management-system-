...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <li class="nav-item">
          <a class="nav-link" href="myoffer.php">My Offer</a>
           ...
           <li class="nav-item">
          <a class="nav-link" href="addpark.php">Parking</a>
        </li>
			...
			<div class="card" style="padding-right: 20px;">
				...
				<div class="card-body" style="padding-right: 20px;">
					<form action="addpark.php" method="post">
						<input type="text" placeholder="park number " class="form-control" name="d"><br>
					

					<input type="submit" value="Add New park" class="btn btn-danger " name="btn">
					</form>
					...
					$day=isset($_POST['d'])?$_POST['d']:'';
						...
						if(isset($_POST['btn']))
						{
							$result=mysqli_query($con,"insert into parking(restname,parknumber,state)
								values('".$_SESSION['id']."','$day',0)");
